...
<html lang="pt-br">
  <head>
    ...
    <link rel="shortcut icon" href="/8091LOGO.ico"/>
    <title>Init Imports</title>
	<!--/tags -->
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/products"> <i class="fas fa-search-plus"></i> Produtos</a></li>
			...
			<div class="side-bar col-md-3">
				<div class="search-hotel">
					...
					<form action="#" method="post">
						<input disabled="true" type="search" placeholder="Product name..." name="search" required="">
						<input disabled="true" type="submit" value=" ">
					</form>
				</div>
				<!-- price range -->
				<!-- //price range -->
				...
				<div class="wrapper">
								...
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="link-product-add-cart">Ver Detalhes</a>
										</div>
									</div>
					...
					<div class="product-sec1 product-sec2">
						<div class="col-xs-7 effect-bg">
							<h3 class="">Os melhores produtos</h3>
							<h6>Réplicas & Originais</h6>
							<p>Tudo 10% Off</p>
						</div>
						<h3 class="w3l-nut-middle">Segurança Total</h3>
