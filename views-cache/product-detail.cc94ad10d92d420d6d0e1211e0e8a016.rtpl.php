        ...
        <div class="container">
            ...
            <div class="col-md-7 single-right-left simpleCart_shelfItem">
                ...
                <div class="product-single-w3l">
                    ...
                    <ul>
                        <li>
                            1 Unidade por produto, se desejar mais contate: <i class="fab fa-instagram"></i> <a href="">@init_imports</a>
                        </li>
                        <li>
                            Mais fotos deste produto: <i class="fab fa-instagram"></i> <a href="">@init_imports</a>
                        </li>
                        <li>
                            Descrição:
                        </li>
